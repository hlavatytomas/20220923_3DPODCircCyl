\begin{tikzpicture}
\node [above right] (figA) at (2.6,1.0) {\includegraphics[width=0.33\textwidth]{\myGraphs/staticImpeller/15_ImpellerCR.png}};
\begin{axis}[
width=0.8\textwidth,
height=8cm,
%~ scale only axis,
...
%merged\addplot+ [mark=none,green!50!white,style=solid]table [x expr=\thisrow{l}*10, y={Uy}] {\myGraphs/staticImpeller/POL_X_merged_Re_100_V18-V8-DEV1OF6};
%merged\label{R4}
%\addlegendentry{$\mathrm{U_{V16rc-V7rc}^{Poly}}$}
%merged\addplot+ [mark=none,green!50!white,style=solid,dashed]table [x expr=\thisrow{l}*10, y={Uy}] {\myGraphs/staticImpeller/POL_X_merged_Re_500_V18-V8-DEV1OF6};
%
...
%~ \node [draw,fill=white,anchor=south west] at (rel axis cs: 0.01,0.2) {\includegraphics[width=0.12\textwidth]{\myGraphs/staticImpeller/30_SubPlotA.png}};
\node [draw,fill=white,anchor=south] at (rel axis cs: 0.5,0.02) {\includegraphics[width=0.18\textwidth]{\myGraphs/staticImpeller/15_SubPlotA.png}};
